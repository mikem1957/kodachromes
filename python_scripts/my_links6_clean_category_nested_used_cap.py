...
ACCESS_TOKEN = 'sl.u.AFv0--ULYmF_GmqZIC16qgcBN5uIjbQoISIlDcwD_3_Of7bnJokDpJEwsIaTrkJc4v-43W-70vgNKB4Sw1tAAYHGK_g0TIgxrKLXbwrd8gAY4y-bItRp0kir9lpXKXDkmUkNZ639920Vt4_5CFx302UhGWT1B52QMt5NwVCOG_e8ULv19a5lwzYFdDDnGHuz1H_E92Bb4rWXl9bHlvM_xkS6llhYt4x8K8vXj8uR-wBQj8d5spAWVqzNN35g_TlVcq8WVaCHeRg_EbhC_a_Tkc7CupNUwWAsuXiWqAzxSdLypkBCQVF_oXSraggJZfRFF2awwbVlY7DrM43XtZYQiJmYUAZulV_Qyz5qBonaUVEv0q1Sp7lLZ7T8wiqnrhAiZXhsl-AKBt6-_Fk1sOJrREah8pdLwKVNLfFvSmAgCv8JjjlVmyvSt2LOEbq_U4AnsA14ls8B-bflOMUdtubWSy8HZdEAvp8Gdzy0Lj5WltQScTP3znb_dcalQNpXtunpmRKNivcr4GxMx-N9dp8XWGivBXMlOTrN9LpFWYkUD6YpQTcNR0ZARVLclsexah1EhMeOjDNtLNClba0IHOtKQAkDkVzonN9vUGab1iTS3439E15a3JOwoYRL65o8zB8CGFafd84I1lOtkDY8ujXvA1DnvBz7cD41SdZrDQxopxy7IQU2zqwCvuok8VX_HRUCJJlVNTwyNSG4SAwoni9a5IypgXP559ylJjhFk6Rc-FS4_nSU3CipP-ZzXI0Yh0Yp-hi1tEx3ngmGEj0td0Sk_AFgWN5Gx-1rkFryL_GMHZH_gbOez-LoX5RWL3uNnNJI9nmQ3WvEjMr3fF3Sd3q6-I6aTzc6kC7QqwqIT9Ft56wLKeA-GSNbJW-WGqUxW4A0e_qWD4y8tCPN4SrVtKVWtt4GwNmPqhRym02F6GMK-O9-SrUpxkXP1bJaeI4do10nwCqd6Jhaw_9WcuX3DnFTLExAfNzazSuHx3jpw_0picRRKdqiP8k61yN5xN58mnHdPnkNfBW7hryMXDGi9XAyapdqt94ywfU6DuNVnjmRpCNUq0U4n1sFojygdB58Fe2HJwjomWLaiYg3I5CdhGeM_vTsypfiqmUpEnZAyEsq6hQnnMqIOocXNjX2iVr9X2MU6SsAraIq4H3P8LW2SFlb3unw3ZVebRKJw0dnnOCizMj4oXn-CAIiVSub4xkopsrFuSLyVW5IqQR0seEQt3jlcnrLcISygVDVSGeHrxxW1I24OQuQVON2ibihYzFhLsLAlNs5bcpDc_7mJu2QM719pksI'

BASE_DROPBOX_PATH = "/kodachromes/RAJ"      # The main folder containing all nested subfolders and images
OUTPUT_JSON = "all_images_data_recursive_clean_cap.json" # Name of the output JSON file
...
def clean_text(text):
    ...
    Converts to lowercase for consistency, then capitalizes the first letter.
    """
    # 1. Remove numbers
    ...
    text = text.lower()
    # 5. Capitalize the first letter if the text is not empty
    if text:
        ...
        while True:
            for entry in response.entries:
                if isinstance(entry, dropbox.files.FileMetadata):
                    ...
                    new_name_field = f"{cleaned_category_name}"

                    all_image_data.append({
                        "name": new_name_field,
                        "category": cleaned_category_name, # original_category_name, # Keep original category name for the 'category' field
